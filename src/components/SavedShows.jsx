  ...
  return (
    <>
      ...
      <div className="relative flex item-center group">
        <MdChevronLeft
          onClick={slideLeft}
          className="rounded-full place-self-center left-0 bg-white absolute opacity-50 hover:opacity-100 cursor-pointer z-10 hidden group-hover:block"
          size={40}
        />
        <div
          id={"slider"}
        ...
        <MdChevronRight
          onClick={slideRight}
          className="rounded-full place-self-center right-0 bg-white absolute opacity-50 hover:opacity-100 cursor-pointer z-10 hidden group-hover:block"
          size={40}
        />
      </div>
    </>
